...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/2_indexLogin.css">
    ...
    <form  action="../includes/inicio.php" method="POST">
        <div class="content">
            <div class="content-2">
                ...
                <label for="name" class="label-opacity"><a href="http://localhost/Universidad/html/3_indexRegister.php">No tienes contraseña? Registrate aquí.</a></label>
